...
// Org-wide discovery of catalog-info.yaml across cmoreira-dev/* repos — see
// catalog.providers.github in app-config.yaml. Means individual repos don't
// need to be registered as catalog.locations one by one.
